//<BarChart.java> -- Reads in 5 integers from user, then prints out a "Bar Chart" using astericks.
//CSIS 212-<WEEK 3>
...
public class BarChart {
    public static void main(String[] args) {
        ...
        System.out.println("David Ryan Lynch - Bar Chart");
        // Initialize Scanner
        Scanner input = new Scanner(System.in);

        //Assign in  5 integer variables
        int number1 = 0;
        int number2 = 0;
        int number3 = 0;
        int number4 = 0;
